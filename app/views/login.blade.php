...
{{HTML::style('assets/css/admin/pages/login.css')}}
...
{{HTML::script('assets/js/plugins/jquery-validation/js/jquery.validate.min.js')}}
...
{{HTML::script('assets/js/scripts/login.js')}}
